...
class LatestProductsManager:
    ...
    def get_products_for_main_page(*args, **kwargs):
        ...
        for ct_model in ct_models:
            model_products = ct_model.model_class()._base_manager.all().order_by('-id')[:50]
...
class Notebook(Product):
    ...
    time_without_charge = models.CharField(max_length = 50, verbose_name = "Время роботы аккумулятора")
